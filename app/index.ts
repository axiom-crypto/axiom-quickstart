import { Axiom, AxiomCrosschain, BridgeType, UserInput } from '@axiom-crypto/client';
...
const axiomMain = async (input: UserInput<CircuitInputs>) => {
  ...
  //   options: {
  //     // maxFeePerGas: "50000",
  //     overrideAxiomQueryFee: "3000000000000001",
  //   }
  // });
  ...
  console.log("ZK proof generated successfully., args: ", args.args);
